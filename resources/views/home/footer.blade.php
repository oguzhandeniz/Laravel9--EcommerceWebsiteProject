            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="address">
                        ...
                        <p>TURKEY ,EUROPA ,USA ,CANADA and soon all over the world.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                ...
                <p class="pull-right">Designed by <span><a target="_blank" href="https://github.com/oguzhandeniz">Oguzhan Deniz</a></span></p>
            </div>
        </div>
    </div>
