                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Show Category: {{$data->title}}</h4>
                            </div>
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-secondary" href="{{route('admin.category.edit', ['id'=>$data->id])}}" role="button" style="width: 100px">Edit</a>
                            <a class="btn btn-danger" onclick="return confirm('Deleting! Are you sure?')"
                               href="{{route('admin.category.destroy', ['id'=>$data->id])}}" role="button" style="width: 100px" >Delete</a>
                        </div>
                    </div>
                </div>
